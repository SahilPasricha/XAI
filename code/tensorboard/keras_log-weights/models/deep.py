...
logs_path = "/home/pasricha/keras_log-weights/log/ts_tweets/"
...
print("************************Small Big Small  MODEL*******************")
base_model = models.Sequential()
base_model.add(layers.Dense(8, activation='relu', input_shape=(NB_WORDS,)))
base_model.add(layers.Dense(128, activation='relu'))
base_model.add(layers.Dense(16, activation='relu'))
base_model.add(layers.Dense(3, activation='softmax'))
base_model.name = 'Small_big_small_model_8_128_16_3'
...
reg_model.add(layers.Dense(32, kernel_regularizer=regularizers.l2(0.001), activation='relu', input_shape=(NB_WORDS,)))
reg_model.add(layers.Dense(128, kernel_regularizer=regularizers.l2(0.001), activation='relu'))
reg_model.add(layers.Dense(3, activation='softmax'))
reg_model.name = 'L2_Regularization_model'
...
print("************************Big Small Big MODEL*******************")
drop_model = models.Sequential()
drop_model.add(layers.Dense(32, activation='relu', input_shape=(NB_WORDS,)))
drop_model.add(layers.Dense(8, activation='relu'))
drop_model.add(layers.Dense(512, activation='relu'))
drop_model.add(layers.Dense(3, activation='softmax'))
drop_model.name = 'Big_small_big_model_32_8_128'
...
compact_model.name = 'Compact_model'
...
reduced_model.add(layers.Dense(8, activation='relu', input_shape=(NB_WORDS,)))
reduced_model.add(layers.Dropout(0.5))
reduced_model.add(layers.Dense(3, activation='softmax'))
reduced_model.name = 'Reduced_model'
...
rereduced_model.name = 'ReReduced_model'
...
compare_models_by_metric(base_model, drop_model, base_history, drop_history, 'val_accuracy')
