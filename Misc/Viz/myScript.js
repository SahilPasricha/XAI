...
function processLines(){
    ...
    // console.log("Information: Ids/Rows --> " + orig_local_data.length)
    // console.log("Information: Cols/Epochs  --> " + (data_header.length-1))
    // console.log("Information: Bins  --> " + bin_size)
...
var reg_binned_data = [];
    for(var i = 0 ;i < bin_size ; ++i ){
        ...
        var temp_data = []
        var rows_arr = [];
    // assuming length dont cover the keys as we have fed the length manually
